...
function XacNhan(props) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { id: 'xac-nhan', className: 'modal fade', role: 'dialog' },
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'label',
                                { htmlFor: 'maXacNhan' },
                                'Nh\u1EADp m\xE3 x\xE1c nh\u1EADn nh\u1EADn \u0111\u01B0\u1EE3c qua tin nh\u1EAFn '
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', id: 'maXacNhan', name: 'maXacNhan', className: 'form-control',
                                'data-error': 'kh\xF4ng \u0111\u01B0\u1EE3c b\u1ECF tr\u1ED1ng', required: true }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { id: 'thongbaoxacnhan', className: 'help-block with-errors', style: { whiteSpace: 'pre-line' } })
                        )
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'button',
                        { type: 'button', className: 'btn btn-default', 'data-dismiss': 'modal', id: 'thayDoi' },
...
function ThongBao(props) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { id: 'thong-bao', className: 'modal fade', role: 'dialog' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { className: 'modal-dialog' },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
var DatCho = function (_React$Component) {
    _inherits(DatCho, _React$Component);

    function DatCho(props) {
        _classCallCheck(this, DatCho);

        var _this = _possibleConstructorReturn(this, (DatCho.__proto__ || Object.getPrototypeOf(DatCho)).call(this, props));

        _this.huyBo = _this.huyBo.bind(_this);
        return _this;
    }

    _createClass(DatCho, [{
        key: 'huyBo',
        value: function huyBo() {
            $("#sdtKhachHang").val('');
        }
    }, {
        key: 'render',
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-success my-btn-success', id: 'dangKy' },
                                '\u0110\u0103ng k\xFD'
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-default', 'data-dismiss': 'modal', onClick: this.huyBo },
                                'H\u1EE7y b\u1ECF'
                            )
                        )
                    )
...
var XemPhong = function (_React$Component2) {
    _inherits(XemPhong, _React$Component2);

    function XemPhong(props) {
        _classCallCheck(this, XemPhong);

        var _this2 = _possibleConstructorReturn(this, (XemPhong.__proto__ || Object.getPrototypeOf(XemPhong)).call(this, props));

        _this2.dangKy = _this2.dangKy.bind(_this2);
        _this2.xacNhan = _this2.xacNhan.bind(_this2);
        _this2.thongBao = _this2.thongBao.bind(_this2);
        _this2.xoaForm = _this2.xoaForm.bind(_this2);
        _this2.thayDoi = _this2.thayDoi.bind(_this2);
        return _this2;
    }

    _createClass(XemPhong, [{
        key: 'dangKy',
        ...
        key: 'xacNhan',
        value: function xacNhan() {
            var _this4 = this;

            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post(location.origin + '/KhachHang/XacNhan', {
                _token: $('meta[name="csrf-token"]').attr('content'),
                sdtKhachHang: $("#sdtKhachHang").val(),
                ...
                if (res.data === 'success') {
                    ...
                    capNhatLuotClick();
                    $("#maXacNhan").val(null);
                    _this4.thongBao('Đặt chỗ thành công');
                    _this4.xoaForm();
                } else {
        ...
        key: 'thayDoi',
        value: function thayDoi() {
            $("#xac-nhan").modal('hide');
            $("#dat-cho").modal('show');
        }
    }, {
        key: 'xoaForm',
        value: function xoaForm() {
            $("#sdtKhachHang").val('');
        }
    }, {
        key: 'thongBao',
        value: function thongBao(notice) {
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                null,
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(DatCho, null),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(XacNhan, null),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ThongBao, null)
            );
        }
    }]);
